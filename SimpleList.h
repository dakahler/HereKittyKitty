...
public:
	...
	inline const iterator begin() const { return _internalArray; }
	inline const iterator end() const { return _internalArray + _endPosition; }

    inline bool empty() { return (_endPosition == 0); }
    inline unsigned int size() const { return _endPosition; }
    inline unsigned int capacity() const { return _allocBlocks; }
